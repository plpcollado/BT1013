...
hebcomp <- function(hdsplit){
  ...
  return(cat("La hebra complementaria es: ", comple))
}
hebdir <- readline(prompt = "Ingresa la secuencia de la hebra directa: ")
hdsplit <- strsplit(hebdir, "")[[1]]
hebcomp(hdsplit)
